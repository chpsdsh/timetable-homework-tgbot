...
func (c *homeworkController) DaysWithLessons(ctx context.Context, userID int64) ([]string, error) {
...
func (c *homeworkController) LessonsByDay(ctx context.Context, userID int64, day string) ([]domain.LessonBrief, error) {
	group, err := c.usersRepo.GetGroup(ctx, userID)
	if err != nil {
		return nil, err
	}
...
func (c *homeworkController) Pin(ctx context.Context, userID int64, day string, subject, text string) error {
...
func (c *homeworkController) Update(ctx context.Context, userID int64, subject, newText string) error {
...
func (c *homeworkController) UpdateStatus(ctx context.Context, userID int64, subject string) error {
...
func (c *homeworkController) DeleteHomework(ctx context.Context, userID int64, subject string) error {
...
func (c *homeworkController) ListForLastWeek(ctx context.Context, userID int64) ([]domain.HWBrief, error) {
...
func (c *homeworkController) CheckExistence(ctx context.Context, userID int64, subject string) (bool, error) {
